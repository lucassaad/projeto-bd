...
from app.schemas.prescription import PrescriptionIn, PrescriptionOut, PrescriptionUpdate
...
@router.post('/', response_model=PrescriptionOut, status_code=HTTPStatus.CREATED)
...
@router.get('/all', response_model=list[PrescriptionOut], status_code=HTTPStatus.OK)
...
def put_prescription(id: int, prescription_update: PrescriptionUpdate, db_session: db_session):
...
@router.delete('/{id}', response_model=PrescriptionOut, status_code=HTTPStatus.OK)

...
from app.schemas.medication import MedicationIn, MedicationOut
...
@router.get(
    '/all', response_model=list[MedicationOut], status_code=HTTPStatus.OK
)
...
@router.delete(
    '/{id}', response_model=MedicationOut, status_code=HTTPStatus.OK
)
